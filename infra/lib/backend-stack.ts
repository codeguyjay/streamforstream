...
export class BackendStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props: BackendStackProps) {
    ...
    this.addDependency(props.ddbStack);
        ...
        taskImageOptions: {
          ...
          environment: {
            ...
            DDB_STREAMER_STATE_TABLE_NAME:
              props.ddbStack.streamerStateTable.tableName,
            DDB_VIEW_REPORTS_TABLE_NAME:
              props.ddbStack.viewReportsTable.tableName,
    ...
    if (taskRole) {
      props.ddbStack.streamerStateTable.grantReadWriteData(taskRole);
      props.ddbStack.viewReportsTable.grantReadWriteData(taskRole);
    }
